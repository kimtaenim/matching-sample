...
4. 고객이 특정 인물을 언급하면 (이름+나이 등) 그 사람을 결과에 반드시 포함.
5. "비슷한 사람" = 이름이 같은 사람이 아님. bio/경력/성격/돌봄유형이 비슷한 사람.
6. 나이/성별/돌봄유형은 목록에 있는 그대로. 임의로 바꾸지 말 것.
7. 조건에 맞는 사람이 없으면 솔직히 없다고.
8. headline은 20자 이내. for_family는 1문장.
9. 이모지 사용 금지.
